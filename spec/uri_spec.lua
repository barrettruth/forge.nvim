...
describe('uri.web on gitlab spellings', function()
  it('reads a work item as the issue it is', function()
    local t = assert(uri.web('https://gitlab.com/gitlab-org/cli/-/work_items/8498'))
    assert.equals('issues', t.collection)
    assert.equals(8498, t.number)
  end)
end)
