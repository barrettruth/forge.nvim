...
describe('config', function()
  ...
  it('returns defaults when vim.g.forge is nil', function()
    ...
    assert.equals('<s-tab>', cfg.keys.pr.filter_prev)
    assert.equals('<tab>', cfg.keys.issue.filter)
    assert.equals('<s-tab>', cfg.keys.issue.filter_prev)
    ...
    assert.equals('<c-d>', cfg.keys.commit.review)
    ...
    assert.equals('<s-tab>', cfg.keys.release.filter_prev)
  end)
